...
def test_phase_zero_agent_modules_are_importable() -> None:
    ...
    from backend.app.agent import context  # noqa: F401
    from backend.app.agent import grounding  # noqa: F401
    from backend.app.agent import model  # noqa: F401
    from backend.app.agent import policy  # noqa: F401
    from backend.app.agent import router  # noqa: F401
    from backend.app.agent import runtime  # noqa: F401
